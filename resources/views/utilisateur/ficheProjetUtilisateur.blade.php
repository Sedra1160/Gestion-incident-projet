                            ...
                            <div class="profile_contant">
                                <div class="contact_inner">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li><i class="fa fa-shopping-cart"></i> : fourni par {{$projet[0]->fournisseur}}</li>
                                    </ul>
                                </div>
                                ...
                                <div class="shadow-lg p-4 mb-4 bg-white">
                                    {{-- <a href="{{route('projet.util')}}" class="btn btn-danger">retour</a> --}}
                                    <form class="row g-3" method="POST" action="{{route('ajout.fournisseurProjet',['id'=>$projets[0]->id])}}">
                                        @csrf
                                        <div class="col-auto">
