                    ...
                    <table class="table table-striped projects">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col">Projet terminer</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 50px"><a href="{{route('projet.fourisseur.edit',['id'=>$projet->id])}}"><i class="fa fa-pencil-square-o green_color" style="font-size:30px"></i></a></td>
                                <td style="width: 50px"><a href="{{route('projet.terminer',['id'=>$projet->id])}}"><i class="fa fa-check-square-o red_color" style="font-size:30px"></i></a></td>    
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
