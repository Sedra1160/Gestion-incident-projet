...
("matricule","nom","prenom","photo","email","mdp") 
values(0002,'Ranaivoarisoa','Sedra','user.png','sedra@gmail.com',md5('admin1234'));
insert into administrateur 
("matricule","nom","prenom","photo","email","mdp") 
values(0001,'Admin','Admin','user.png','admin@gmail.com',md5('admin1234'));

CREATE TABLE Priorite(
    id Integer PRIMARY KEY,
    nom VARCHAR(255)
)
insert into Priorite values(1,'ca peut attendre');
insert into Priorite values(2,'moyennement prioritaire');
insert into Priorite values(3,'priorité maximale');
...
insert into Statut values(2,'en developpement');
insert into Statut values(3,'fini');
...
CREATE TABLE type_incidents(
    id Integer PRIMARY KEY NOT NULL DEFAULT NEXTVAL('sequenceTypeIncident'),
    nom VARCHAR(255) NOT NULL,
    supprimer int
);
ALTER TABLE type_incidents ADD supprimer int

insert into type_incidents (nom) values('informatique');
insert into type_incidents (nom) values('materiel');
insert into type_incidents (nom) values('naturel');
insert into type_incidents (nom) values('travail');
...
ALTER TABLE intervenants DROP COLUMN image;
